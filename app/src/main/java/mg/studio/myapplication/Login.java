...
import mg.studio.intentreceiver.MainActivity;
import mg.studio.intentreceiver.SecondActivity;
...
public class Login extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * the user already logged in, is yest  then go to the UserNameActivity
         */
        session = new SessionManager(getApplicationContext());

        if (session.isLoggedIn()) {
            startActivity(new Intent(this, listView.MainActivity.class));
            finish();
        }
    ...
    class OnlineCredentialValidation extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer mFeedback) {
            ...
            if (mFeedback == feedback.SUCCESS) {
                ...
                // Move the user to UserNameActivity and pass in the User name which was form the server
                Intent intent = new Intent(getApplication(), listView.MainActivity.class);
