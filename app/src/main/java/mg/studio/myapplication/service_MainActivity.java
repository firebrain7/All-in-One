...
public class service_MainActivity extends AppCompatActivity {
    ...
    public void btnSend(View view) {
        ...
        intent.setAction(service_MyService.ACTION_MSG_TO_SERVICE);
        intent.putExtra(service_MyService.KEY_MSG_TO_SERVICE, msgToService);
    ...
    protected void onStart() {
        ...
        intentFilter.addAction(service_MyService.ACTION_UPDATE_CNT);
        intentFilter.addAction(service_MyService.ACTION_UPDATE_MSG);
        intentFilter.addAction(service_MyService.ACTION_UPDATE_USER_SERVICE_DEAD);
    ...
    private void startService() {
        ...
        myIntent = new Intent(this, service_MyService.class);
    ...
    private class MyMainReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(service_MyService.ACTION_UPDATE_CNT)) {
                int int_from_service = intent.getIntExtra(service_MyService.KEY_INT_FROM_SERVICE, 0);
                textViewCntReceived.setText("Service running for \n " + String.valueOf(int_from_service) + "seconds");
            } else if (action.equals(service_MyService.ACTION_UPDATE_MSG)) {
                String string_from_service = intent.getStringExtra(service_MyService.KEY_STRING_FROM_SERVICE);
                textViewMsgReceived.setText(String.valueOf(string_from_service));
            } else if (action.equals(service_MyService.ACTION_UPDATE_USER_SERVICE_DEAD)) {
                String statusService = intent.getStringExtra(service_MyService.KEY_STRING_FROM_SERVICE_INFO);
