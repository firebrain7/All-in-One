...
public class custom_adapter_MainActivity extends AppCompatActivity {
    /*
        1 - Create a specific design for the item list: it may contain two or more view to be populated
     */
    //The arrayList to populate the listView
    private ArrayList<custom_adapter_Student> studentsList = new ArrayList<custom_adapter_Student>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        custom_adapter_StudentArrayAdapter studentArrayAdapter =
                new custom_adapter_StudentArrayAdapter(
                        getBaseContext(), // Current context
                        R.layout.custom_adapter_item_layout, // the layout for each item in the list
    ...
    private void generateDummyContent() {
        ...
        for (String element : nameDummy) {
            ...
            studentsList.add(new custom_adapter_Student(studentName, Integer.valueOf(studentId)));
