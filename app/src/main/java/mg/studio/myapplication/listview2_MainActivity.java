...
public class listview2_MainActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.listview2_activity_main);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(this, R.layout.listview2_item_layout, R.id.item_text, arrayDemo);
